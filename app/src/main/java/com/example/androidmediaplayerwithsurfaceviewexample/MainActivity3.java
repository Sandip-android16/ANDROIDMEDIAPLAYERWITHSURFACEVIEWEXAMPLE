...
public class MainActivity3 extends AppCompatActivity implements  OnBufferingUpdateListener, OnCompletionListener, OnPreparedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("aaa", "Media player activity called ");
